...
import { colorsDark, colorsLight } from "./theme.ts";
import { z } from "zod";
...
export const transformConfig = <TConfig extends PartialDeep<Config>>(
  ...
  const mergedConfig = _.merge(defaultConfig, config) as TConfig & Config;
  ...
  return {
    ...mergedConfig,
    typography,
    fontFamily: typeof mergedConfig.font === "string"
      ? mergedConfig.font
      : "custom-font",
    registerFonts,
  };
